<%-- 
    Document   : all_patients
    Created on : 23-Apr-2023, 2:33:59 pm
    Author     : hp
--%>
							...
							<tbody>
								<% 
                                                                ...
                                                                try{
                                                                    ...
                                                                    ResultSet rs=st.executeQuery("Select * from app_details");
                                                                    while(rs.next()){
                                                                    out.print("<tr>");
                                                                    ...
                                                                    out.print("<td><form action=delete_app.jsp><input type=hidden value='"+rs.getString(1)+"' name=\"fname\"/><input type=submit value="+"Delete"+" name=submit/></form>");
                                                                    out.print("</tr>");
                                                                    }
