 <%-- 
    Document   : patients_app
    Created on : 22-Apr-2023, 3:18:00 pm
    Author     : hp
--%>
								...
								<% 
                                                                ...
                                                                try{
                                                                    ...
                                                                    out.print("<td>"+rs.getString(9)+"</td>");
                                                                     out.print("<td><form action=del_app.jsp><input type=hidden value='"+rs.getString(1)+"' name=\"fname\"/><input type=submit value="+"Delete"+" name=submit/></form>");
                                                                    out.print("</tr>");
                                                                    }
                                                                    }
